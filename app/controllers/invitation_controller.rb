class InvitationController < ApplicationController
  ...
  def update
    ...
    return back_with_message(t('messages.invitations.updated_details'))
  end
  ...
  def no_tutorial_selected?
    @invitation.role.eql?('Student') && params[:workshop_invitation][:tutorial].blank?
  end
